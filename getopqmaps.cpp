...
QList<_special_function> OP_QMaps::getAllSpecialFunctionsSortOrder()
{
    ...
    _SF_ALL_QMAP_SORT.insert(117, SF_RC1_PASS);
    _SF_ALL_QMAP_SORT.insert(118, SF_RC2_PASS);
    _SF_ALL_QMAP_SORT.insert(119, SF_RC3_PASS);
    _SF_ALL_QMAP_SORT.insert(120, SF_RC4_PASS);
    _SF_ALL_QMAP_SORT.insert(121, SF_RC6_PASS);
    _SF_ALL_QMAP_SORT.insert(122, SF_RC7_PASS);
    _SF_ALL_QMAP_SORT.insert(123, SF_RC8_PASS);
    _SF_ALL_QMAP_SORT.insert(124, SF_RC1_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(125, SF_RC2_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(126, SF_RC3_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(127, SF_RC4_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(128, SF_RC6_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(129, SF_RC7_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(130, SF_RC8_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(131, SF_BARREL_STAB_ON);
    _SF_ALL_QMAP_SORT.insert(132, SF_BARREL_STAB_OFF);
    _SF_ALL_QMAP_SORT.insert(133, SF_BARREL_STAB_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(134, SF_BARREL_STAB_LEVEL);
    _SF_ALL_QMAP_SORT.insert(135, SF_HILLS_ON);
    _SF_ALL_QMAP_SORT.insert(136, SF_HILLS_OFF);
    _SF_ALL_QMAP_SORT.insert(137, SF_HILLS_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(138, SF_HILLS_LEVEL);
    _SF_ALL_QMAP_SORT.insert(139, SF_USER_FUNC_1);
    _SF_ALL_QMAP_SORT.insert(140, SF_USER_FUNC_2);
    _SF_ALL_QMAP_SORT.insert(141, SF_USER_ANLG_1);
    _SF_ALL_QMAP_SORT.insert(142, SF_USER_ANLG_2);
    _SF_ALL_QMAP_SORT.insert(143, SF_DUMP_DEBUG);
