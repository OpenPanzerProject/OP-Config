...
QList<_special_function> OP_QMaps::getAllSpecialFunctionsSortOrder()
{
    ...
    _SF_ALL_QMAP_SORT.insert(77, SF_MOTOR_A);
    _SF_ALL_QMAP_SORT.insert(78, SF_MOTOR_A_ON);
    _SF_ALL_QMAP_SORT.insert(79, SF_MOTOR_A_OFF);
    _SF_ALL_QMAP_SORT.insert(80, SF_MOTOR_A_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(81, SF_MOTOR_B);
    _SF_ALL_QMAP_SORT.insert(82, SF_MOTOR_B_ON);
    _SF_ALL_QMAP_SORT.insert(83, SF_MOTOR_B_OFF);
    _SF_ALL_QMAP_SORT.insert(84, SF_MOTOR_B_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(85, SF_SET_VOLUME);
    _SF_ALL_QMAP_SORT.insert(86, SF_INCR_VOLUME);
    _SF_ALL_QMAP_SORT.insert(87, SF_DECR_VOLUME);
    _SF_ALL_QMAP_SORT.insert(88, SF_STOP_VOLUME);
    _SF_ALL_QMAP_SORT.insert(89, SF_OVERLAY_ENABLE);
    _SF_ALL_QMAP_SORT.insert(90, SF_OVERLAY_DISABLE);
    _SF_ALL_QMAP_SORT.insert(91, SF_USER_SOUND1_ONCE);
    _SF_ALL_QMAP_SORT.insert(92, SF_USER_SOUND1_RPT);
    _SF_ALL_QMAP_SORT.insert(93, SF_USER_SOUND1_OFF);
    _SF_ALL_QMAP_SORT.insert(94, SF_USER_SOUND2_ONCE);
    _SF_ALL_QMAP_SORT.insert(95, SF_USER_SOUND2_RPT);
    _SF_ALL_QMAP_SORT.insert(96, SF_USER_SOUND2_OFF);
    _SF_ALL_QMAP_SORT.insert(97, SF_USER_SOUND3_ONCE);
    _SF_ALL_QMAP_SORT.insert(98, SF_USER_SOUND3_RPT);
    _SF_ALL_QMAP_SORT.insert(99, SF_USER_SOUND3_OFF);
    _SF_ALL_QMAP_SORT.insert(100, SF_USER_SOUND4_ONCE);
    _SF_ALL_QMAP_SORT.insert(101, SF_USER_SOUND4_RPT);
    _SF_ALL_QMAP_SORT.insert(102, SF_USER_SOUND4_OFF);
    _SF_ALL_QMAP_SORT.insert(103, SF_USER_SOUND5_ONCE);
    _SF_ALL_QMAP_SORT.insert(104, SF_USER_SOUND5_RPT);
    _SF_ALL_QMAP_SORT.insert(105, SF_USER_SOUND5_OFF);
    _SF_ALL_QMAP_SORT.insert(106, SF_USER_SOUND6_ONCE);
    _SF_ALL_QMAP_SORT.insert(107, SF_USER_SOUND6_RPT);
    _SF_ALL_QMAP_SORT.insert(108, SF_USER_SOUND6_OFF);
    _SF_ALL_QMAP_SORT.insert(109, SF_USER_SOUND7_ONCE);
    _SF_ALL_QMAP_SORT.insert(110, SF_USER_SOUND7_RPT);
    _SF_ALL_QMAP_SORT.insert(111, SF_USER_SOUND7_OFF);
    _SF_ALL_QMAP_SORT.insert(112, SF_USER_SOUND8_ONCE);
    _SF_ALL_QMAP_SORT.insert(113, SF_USER_SOUND8_RPT);
    _SF_ALL_QMAP_SORT.insert(114, SF_USER_SOUND8_OFF);
    _SF_ALL_QMAP_SORT.insert(115, SF_USER_SOUND9_ONCE);
    _SF_ALL_QMAP_SORT.insert(116, SF_USER_SOUND9_RPT);
    _SF_ALL_QMAP_SORT.insert(117, SF_USER_SOUND9_OFF);
    _SF_ALL_QMAP_SORT.insert(118, SF_USER_SOUND10_ONCE);
    _SF_ALL_QMAP_SORT.insert(119, SF_USER_SOUND10_RPT);
    _SF_ALL_QMAP_SORT.insert(120, SF_USER_SOUND10_OFF);
    _SF_ALL_QMAP_SORT.insert(121, SF_USER_SOUND11_ONCE);
    _SF_ALL_QMAP_SORT.insert(122, SF_USER_SOUND11_RPT);
    _SF_ALL_QMAP_SORT.insert(123, SF_USER_SOUND11_OFF);
    _SF_ALL_QMAP_SORT.insert(124, SF_USER_SOUND12_ONCE);
    _SF_ALL_QMAP_SORT.insert(125, SF_USER_SOUND12_RPT);
    _SF_ALL_QMAP_SORT.insert(126, SF_USER_SOUND12_OFF);
    _SF_ALL_QMAP_SORT.insert(127, SF_USER_SOUND_ALL_OFF);
    _SF_ALL_QMAP_SORT.insert(128, SF_SBA_PLAYSTOP);
    _SF_ALL_QMAP_SORT.insert(129, SF_SBA_NEXT);
    _SF_ALL_QMAP_SORT.insert(130, SF_SBA_PREVIOUS);
    _SF_ALL_QMAP_SORT.insert(131, SF_SBA_RANDOM);
    _SF_ALL_QMAP_SORT.insert(132, SF_SBB_PLAYSTOP);
    _SF_ALL_QMAP_SORT.insert(133, SF_SBB_NEXT);
    _SF_ALL_QMAP_SORT.insert(134, SF_SBB_PREVIOUS);
    _SF_ALL_QMAP_SORT.insert(135, SF_SBB_RANDOM);
    _SF_ALL_QMAP_SORT.insert(136, SF_RC1_PASS);
    _SF_ALL_QMAP_SORT.insert(137, SF_RC2_PASS);
    _SF_ALL_QMAP_SORT.insert(138, SF_RC3_PASS);
    _SF_ALL_QMAP_SORT.insert(139, SF_RC4_PASS);
    _SF_ALL_QMAP_SORT.insert(140, SF_RC6_PASS);
    _SF_ALL_QMAP_SORT.insert(141, SF_RC7_PASS);
    _SF_ALL_QMAP_SORT.insert(142, SF_RC8_PASS);
    _SF_ALL_QMAP_SORT.insert(143, SF_RC1_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(144, SF_RC2_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(145, SF_RC3_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(146, SF_RC4_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(147, SF_RC6_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(148, SF_RC7_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(149, SF_RC8_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(150, SF_BARREL_STAB_ON);
    _SF_ALL_QMAP_SORT.insert(151, SF_BARREL_STAB_OFF);
    _SF_ALL_QMAP_SORT.insert(152, SF_BARREL_STAB_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(153, SF_BARREL_STAB_LEVEL);
    _SF_ALL_QMAP_SORT.insert(154, SF_HILLS_ON);
    _SF_ALL_QMAP_SORT.insert(155, SF_HILLS_OFF);
    _SF_ALL_QMAP_SORT.insert(156, SF_HILLS_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(157, SF_HILLS_LEVEL);
    _SF_ALL_QMAP_SORT.insert(158, SF_USER_FUNC_1);
    _SF_ALL_QMAP_SORT.insert(159, SF_USER_FUNC_2);
    _SF_ALL_QMAP_SORT.insert(160, SF_USER_ANLG_1);
    _SF_ALL_QMAP_SORT.insert(161, SF_USER_ANLG_2);
    _SF_ALL_QMAP_SORT.insert(162, SF_DUMP_DEBUG);
