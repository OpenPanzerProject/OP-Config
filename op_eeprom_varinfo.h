...
const _storage_var_info STORAGEVARS[NUM_STORED_VARS] = {
    ...
    {1911, 296, varINT16, "1000"},        // SteeringServo_EPMin
    {1912, 298, varINT16, "2000"},        // SteeringServo_EPMax
    {1913, 300, varBOOL, "0"},        // SteeringServo_Reversed
    {2011, 301, varBOOL, "0"},        // Airsoft
    {2012, 302, varBOOL, "1"},        // MechanicalBarrelWithCannon
    {2013, 303, varINT16, "0"},        // RecoilDelay
    {2014, 305, varBOOL, "1"},        // RecoilReversed
    {2015, 306, varBOOL, "1"},        // ServoRecoilWithCannon
    {2016, 307, varINT16, "200"},        // RecoilServo_Recoil_mS
    {2017, 309, varINT16, "800"},        // RecoilServo_Return_mS
    {2018, 311, varINT16, "1000"},        // RecoilServo_EPMin
    {2019, 313, varINT16, "2000"},        // RecoilServo_EPMax
    {2211, 315, varBOOL, "1"},        // SmokerControlAuto
    {2212, 316, varINT16, "89"},        // SmokerIdleSpeed
    {2213, 318, varINT16, "128"},        // SmokerFastIdleSpeed
    {2214, 320, varINT16, "255"},        // SmokerMaxSpeed
    {2215, 322, varINT16, "255"},        // SmokerDestroyedSpeed
    {2411, 324, varBOOL, "1"},        // AccelRampEnabled_1
    {2412, 325, varUINT8, "4"},        // AccelSkipNum_1
    {2413, 326, varUINT8, "0"},        // AccelPreset_1
    {2414, 327, varBOOL, "1"},        // DecelRampEnabled_1
    {2415, 328, varUINT8, "4"},        // DecelSkipNum_1
    {2416, 329, varUINT8, "0"},        // DecelPreset_1
    {2417, 330, varBOOL, "0"},        // AccelRampEnabled_2
    {2418, 331, varUINT8, "1"},        // AccelSkipNum_2
    {2419, 332, varUINT8, "0"},        // AccelPreset_2
    {2420, 333, varBOOL, "0"},        // DecelRampEnabled_2
    {2421, 334, varUINT8, "1"},        // DecelSkipNum_2
    {2422, 335, varUINT8, "0"},        // DecelPreset_2
    {2423, 336, varUINT8, "40"},        // BrakeSensitivityPct
    {2424, 337, varUINT16, "1000"},        // TimeToShift_mS
    {2425, 339, varUINT16, "1000"},        // EnginePauseTime_mS
    {2426, 341, varUINT16, "2000"},        // TransmissionDelay_mS
    {2427, 343, varBOOL, "1"},        // NeutralTurnAllowed
    {2428, 344, varUINT8, "50"},        // NeutralTurnPct
    {2429, 345, varUINT8, "2"},        // TurnMode
    {2430, 346, varUINT8, "1"},        // DriveType
    {2431, 347, varUINT8, "100"},        // MaxForwardSpeedPct
    {2432, 348, varUINT8, "70"},        // MaxReverseSpeedPct
    {2433, 349, varUINT8, "50"},        // HalftrackTreadTurnPct
    {2434, 350, varBOOL, "0"},        // EngineAutoStart
    {2435, 351, varINT32, "0"},        // EngineAutoStopTime_mS
    {2436, 355, varUINT8, "0"},        // MotorNudgePct
    {2437, 356, varUINT16, "250"},        // NudgeTime_mS
    {2438, 358, varBOOL, "0"},        // DragInnerTrack
    {2439, 359, varBOOL, "0"},        // EnableTrackRecoil
    {2440, 360, varUINT8, "100"},        // TrackRecoilKickbackSpeed
    {2441, 361, varUINT8, "65"},        // TrackRecoilDecelerateFactor
    {2511, 362, varBOOL, "0"},        // EnableBarrelStabilize
    {2512, 363, varUINT8, "50"},        // BarrelSensitivity
    {2513, 364, varBOOL, "0"},        // EnableHillPhysics
    {2514, 365, varUINT8, "50"},        // HillSensitivity
    {2711, 366, varINT16, "350"},        // IgnoreTurretDelay_mS
    {2811, 368, varUINT8, "0"},        // SoundDevice
    {2812, 369, varUINT16, "1500"},        // Squeak1_MinInterval_mS
    {2813, 371, varUINT16, "4000"},        // Squeak1_MaxInterval_mS
    {2814, 373, varUINT16, "2000"},        // Squeak2_MinInterval_mS
    {2815, 375, varUINT16, "5000"},        // Squeak2_MaxInterval_mS
    {2816, 377, varUINT16, "3000"},        // Squeak3_MinInterval_mS
    {2817, 379, varUINT16, "8000"},        // Squeak3_MaxInterval_mS
    {2818, 381, varBOOL, "0"},        // Squeak1_Enabled
    {2819, 382, varBOOL, "0"},        // Squeak2_Enabled
    {2820, 383, varBOOL, "0"},        // Squeak3_Enabled
    {2821, 384, varUINT8, "25"},        // MinSqueakSpeed
    {2822, 385, varBOOL, "1"},        // HeadlightSound_Enabled
    {2823, 386, varBOOL, "1"},        // TurretSound_Enabled
    {2824, 387, varBOOL, "1"},        // BarrelSound_Enabled
    {2825, 388, varUINT16, "1000"},        // Squeak4_MinInterval_mS
    {2826, 390, varUINT16, "2000"},        // Squeak4_MaxInterval_mS
    {2827, 392, varUINT16, "3000"},        // Squeak5_MinInterval_mS
    {2828, 394, varUINT16, "4000"},        // Squeak5_MaxInterval_mS
    {2829, 396, varUINT16, "5000"},        // Squeak6_MinInterval_mS
    {2830, 398, varUINT16, "6000"},        // Squeak6_MaxInterval_mS
    {2831, 400, varBOOL, "0"},        // Squeak4_Enabled
    {2832, 401, varBOOL, "0"},        // Squeak5_Enabled
    {2833, 402, varBOOL, "0"},        // Squeak6_Enabled
    {2834, 403, varUINT8, "50"},        // VolumeEngine
    {2835, 404, varUINT8, "50"},        // VolumeTrackOverlay
    {2836, 405, varUINT8, "50"},        // VolumeEffects
    {2837, 406, varBOOL, "0"},        // HeadlightSound2_Enabled
    {2838, 407, varBOOL, "0"},        // SoundBankA_Loop
    {2839, 408, varBOOL, "0"},        // SoundBankB_Loop
    {3011, 409, varUINT8, "1"},        // IR_FireProtocol
    {3012, 410, varUINT8, "0"},        // IR_HitProtocol_2
    {3013, 411, varUINT8, "10"},        // IR_RepairProtocol
    {3014, 412, varUINT8, "0"},        // IR_MGProtocol
    {3015, 413, varBOOL, "0"},        // Use_MG_Protocol
    {3016, 414, varBOOL, "0"},        // Accept_MG_Damage
    {3017, 415, varUINT8, "0"},        // DamageProfile
    {3018, 416, varUINT16, "1500"},        // CustomClassSettings.reloadTime
    {3019, 418, varUINT16, "8000"},        // CustomClassSettings.recoveryTime
    {3020, 420, varUINT8, "1"},        // CustomClassSettings.maxHits
    {3021, 421, varUINT8, "10"},        // CustomClassSettings.maxMGHits
    {3022, 422, varBOOL, "0"},        // SendTankID
    {3023, 423, varUINT16, "1"},        // TankID
    {3024, 425, varUINT8, "0"},        // IR_Team
    {3211, 426, varUINT32, "115200"},        // USBSerialBaud
    {3212, 430, varUINT32, "115200"},        // AuxSerialBaud
    {3213, 434, varUINT32, "38400"},        // MotorSerialBaud
    {3214, 438, varUINT32, "38400"},        // Serial3TxBaud
    {3215, 442, varBOOL, "0"},        // LVC_Enabled
    {3216, 443, varUINT16, "6400"},        // LVC_Cutoff_mV
    {3411, 445, varBOOL, "0"},        // RunningLightsAlwaysOn
    {3412, 446, varUINT8, "30"},        // RunningLightsDimLevelPct
    {3413, 447, varBOOL, "0"},        // BrakesAutoOnAtStop
    {3414, 448, varUINT16, "30"},        // AuxLightFlashTime_mS
    {3415, 450, varUINT16, "30"},        // AuxLightBlinkOnTime_mS
    {3416, 452, varUINT16, "30"},        // AuxLightBlinkOffTime_mS
    {3417, 454, varUINT8, "30"},        // AuxLightPresetDim
    {3418, 455, varUINT8, "30"},        // MGLightBlink_mS
    {3419, 456, varBOOL, "1"},        // FlashLightsWhenSignalLost
    {3420, 457, varBOOL, "1"},        // HiFlashWithCannon
    {3421, 458, varBOOL, "0"},        // AuxFlashWithCannon
    {3422, 459, varUINT8, "30"},        // SecondMGLightBlink_mS
    {3423, 460, varBOOL, "1"},        // CannonReloadBlink
    {3611, 461, varUINT8, "12"},        // ScoutCurrentLimit
    {9011, 462, varBOOL, "1"},        // PrintDebug
    {9999, 463, varUINT32, "43589"}        // InitStamp
};
