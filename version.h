...
#define VER_FILEVERSION              0,93,60,00
#define VER_FILEVERSION_STR         "0.93.60.00\0"
...
#define VER_PRODUCTVERSION           0,93,60,00
#define VER_PRODUCTVERSION_STR      "0.93.60\0"

// THIS VERSION IS THE MINIMUM VERSION OF TCB FIRMWARE NEEDED FOR THIS VERSION OF OP CONFIG:
#define VER_MINTCB_STR              "0.93.60\0"

#define VER_COPYRIGHT_YEAR_STR      "2019"      // Change it below as well v
#define VER_COMPANYNAME_STR         "OpenPanzer.org"
#define VER_FILEDESCRIPTION_STR     "OP Config"
#define VER_INTERNALNAME_STR        "OP Config"
#define VER_LEGALCOPYRIGHT_STR      "Copyright (C) 2019 OpenPanzer.org"
