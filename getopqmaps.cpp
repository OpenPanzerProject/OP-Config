...
QMap<_special_function, QString> OP_QMaps::getAllSpecialFunctionsQMap()
{
    ...
    _SF_ALL_QMAP.insert(SF_IR_ENABLE, "IR - Enable");
    _SF_ALL_QMAP.insert(SF_IR_DISABLE, "IR - Disable");
    _SF_ALL_QMAP.insert(SF_IR_TOGGLE, "IR - Toggle On/Off");
    ...
    _SF_ALL_QMAP.insert(SF_USER_SOUND_ALL_OFF, "User Sounds - Stop All");
    ...
    _SF_ALL_QMAP.insert(SF_SMOKER_MANTOGGLE, "Smoker - Manual Toggle");
    _SF_ALL_QMAP.insert(SF_SMOKE_PREHEAT_ON, "Smoker Preheat - Enable");
    _SF_ALL_QMAP.insert(SF_SMOKE_PREHEAT_OFF, "Smoker Preheat - Disable");
    _SF_ALL_QMAP.insert(SF_SMOKE_PREHEAT_TOGGLE, "Smoker Preheat - Toggle");
...
QList<_special_function> OP_QMaps::getAllSpecialFunctionsSortOrder()
{
    ...
    _SF_ALL_QMAP_SORT.insert(21, SF_IR_ENABLE);
    _SF_ALL_QMAP_SORT.insert(22, SF_IR_DISABLE);
    _SF_ALL_QMAP_SORT.insert(23, SF_IR_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(24, SF_LIGHT1_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(25, SF_LIGHT1_ON);
    _SF_ALL_QMAP_SORT.insert(26, SF_LIGHT1_OFF);
    _SF_ALL_QMAP_SORT.insert(27, SF_LIGHT2_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(28, SF_LIGHT2_ON);
    _SF_ALL_QMAP_SORT.insert(29, SF_LIGHT2_OFF);
    _SF_ALL_QMAP_SORT.insert(30, SF_RUNNINGLIGHTS_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(31, SF_RUNNINGLIGHTS_ON);
    _SF_ALL_QMAP_SORT.insert(32, SF_RUNNINGLIGHTS_OFF);
    _SF_ALL_QMAP_SORT.insert(33, SF_AUXOUT_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(34, SF_AUXOUT_ON);
    _SF_ALL_QMAP_SORT.insert(35, SF_AUXOUT_OFF);
    _SF_ALL_QMAP_SORT.insert(36, SF_AUXOUT_LEVEL);
    _SF_ALL_QMAP_SORT.insert(37, SF_AUXOUT_PRESETDIM);
    _SF_ALL_QMAP_SORT.insert(38, SF_AUXOUT_TOGGLEDIM);
    _SF_ALL_QMAP_SORT.insert(39, SF_AUXOUT_FLASH);
    _SF_ALL_QMAP_SORT.insert(40, SF_AUXOUT_INV_FLASH);
    _SF_ALL_QMAP_SORT.insert(41, SF_AUXOUT_BLINK);
    _SF_ALL_QMAP_SORT.insert(42, SF_AUXOUT_TOGGLEBLINK);
    _SF_ALL_QMAP_SORT.insert(43, SF_AUXOUT_REVOLVE);
    _SF_ALL_QMAP_SORT.insert(44, SF_AUXOUT_TOGGLEREVOLVE);
    _SF_ALL_QMAP_SORT.insert(45, SF_OUTPUT_A_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(46, SF_OUTPUT_A_ON);
    _SF_ALL_QMAP_SORT.insert(47, SF_OUTPUT_A_OFF);
    _SF_ALL_QMAP_SORT.insert(48, SF_OUTPUT_A_PULSE);
    _SF_ALL_QMAP_SORT.insert(49, SF_OUTPUT_A_BLINK);
    _SF_ALL_QMAP_SORT.insert(50, SF_OUTPUT_B_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(51, SF_OUTPUT_B_ON);
    _SF_ALL_QMAP_SORT.insert(52, SF_OUTPUT_B_OFF);
    _SF_ALL_QMAP_SORT.insert(53, SF_OUTPUT_B_PULSE);
    _SF_ALL_QMAP_SORT.insert(54, SF_OUTPUT_B_BLINK);
    _SF_ALL_QMAP_SORT.insert(55, SF_ACCEL_LEVEL);
    _SF_ALL_QMAP_SORT.insert(56, SF_DECEL_LEVEL);
    _SF_ALL_QMAP_SORT.insert(57, SF_TURNMODE_1);
    _SF_ALL_QMAP_SORT.insert(58, SF_TURNMODE_2);
    _SF_ALL_QMAP_SORT.insert(59, SF_TURNMODE_3);
    _SF_ALL_QMAP_SORT.insert(60, SF_NT_ENABLE);
    _SF_ALL_QMAP_SORT.insert(61, SF_NT_DISABLE);
    _SF_ALL_QMAP_SORT.insert(62, SF_NT_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(63, SF_DRIVEPROFILE_1);
    _SF_ALL_QMAP_SORT.insert(64, SF_DRIVEPROFILE_2);
    _SF_ALL_QMAP_SORT.insert(65, SF_DRIVEPROFILE_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(66, SF_SPEED_75);
    _SF_ALL_QMAP_SORT.insert(67, SF_SPEED_50);
    _SF_ALL_QMAP_SORT.insert(68, SF_SPEED_25);
    _SF_ALL_QMAP_SORT.insert(69, SF_SPEED_RESTORE);
    _SF_ALL_QMAP_SORT.insert(70, SF_SMOKER);                // Manual speed
    _SF_ALL_QMAP_SORT.insert(71, SF_SMOKER_ON);             // Manual on
    _SF_ALL_QMAP_SORT.insert(72, SF_SMOKER_OFF);            // Manual off
    _SF_ALL_QMAP_SORT.insert(73, SF_SMOKER_MANTOGGLE);      // Manual toggle
    _SF_ALL_QMAP_SORT.insert(74, SF_SMOKER_ENABLE);         // Auto enable
    _SF_ALL_QMAP_SORT.insert(75, SF_SMOKER_DISABLE);        // Auto disable
    _SF_ALL_QMAP_SORT.insert(76, SF_SMOKER_TOGGLE);         // Auto toggle
    _SF_ALL_QMAP_SORT.insert(77, SF_SMOKE_PREHEAT_ON);
    _SF_ALL_QMAP_SORT.insert(78, SF_SMOKE_PREHEAT_OFF);
    _SF_ALL_QMAP_SORT.insert(79, SF_SMOKE_PREHEAT_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(80, SF_MOTOR_A);
    _SF_ALL_QMAP_SORT.insert(81, SF_MOTOR_A_ON);
    _SF_ALL_QMAP_SORT.insert(82, SF_MOTOR_A_OFF);
    _SF_ALL_QMAP_SORT.insert(83, SF_MOTOR_A_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(84, SF_MOTOR_B);
    _SF_ALL_QMAP_SORT.insert(85, SF_MOTOR_B_ON);
    _SF_ALL_QMAP_SORT.insert(86, SF_MOTOR_B_OFF);
    _SF_ALL_QMAP_SORT.insert(87, SF_MOTOR_B_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(88, SF_SET_VOLUME);
    _SF_ALL_QMAP_SORT.insert(89, SF_INCR_VOLUME);
    _SF_ALL_QMAP_SORT.insert(90, SF_DECR_VOLUME);
    _SF_ALL_QMAP_SORT.insert(91, SF_STOP_VOLUME);
    _SF_ALL_QMAP_SORT.insert(92, SF_OVERLAY_ENABLE);
    _SF_ALL_QMAP_SORT.insert(93, SF_OVERLAY_DISABLE);
    _SF_ALL_QMAP_SORT.insert(94, SF_USER_SOUND1_ONCE);
    _SF_ALL_QMAP_SORT.insert(95, SF_USER_SOUND1_RPT);
    _SF_ALL_QMAP_SORT.insert(96, SF_USER_SOUND1_OFF);
    _SF_ALL_QMAP_SORT.insert(97, SF_USER_SOUND2_ONCE);
    _SF_ALL_QMAP_SORT.insert(98, SF_USER_SOUND2_RPT);
    _SF_ALL_QMAP_SORT.insert(99, SF_USER_SOUND2_OFF);
    _SF_ALL_QMAP_SORT.insert(100, SF_USER_SOUND3_ONCE);
    _SF_ALL_QMAP_SORT.insert(101, SF_USER_SOUND3_RPT);
    _SF_ALL_QMAP_SORT.insert(102, SF_USER_SOUND3_OFF);
    _SF_ALL_QMAP_SORT.insert(103, SF_USER_SOUND4_ONCE);
    _SF_ALL_QMAP_SORT.insert(104, SF_USER_SOUND4_RPT);
    _SF_ALL_QMAP_SORT.insert(105, SF_USER_SOUND4_OFF);
    _SF_ALL_QMAP_SORT.insert(106, SF_USER_SOUND5_ONCE);
    _SF_ALL_QMAP_SORT.insert(107, SF_USER_SOUND5_RPT);
    _SF_ALL_QMAP_SORT.insert(108, SF_USER_SOUND5_OFF);
    _SF_ALL_QMAP_SORT.insert(109, SF_USER_SOUND6_ONCE);
    _SF_ALL_QMAP_SORT.insert(110, SF_USER_SOUND6_RPT);
    _SF_ALL_QMAP_SORT.insert(111, SF_USER_SOUND6_OFF);
    _SF_ALL_QMAP_SORT.insert(112, SF_USER_SOUND7_ONCE);
    _SF_ALL_QMAP_SORT.insert(113, SF_USER_SOUND7_RPT);
    _SF_ALL_QMAP_SORT.insert(114, SF_USER_SOUND7_OFF);
    _SF_ALL_QMAP_SORT.insert(115, SF_USER_SOUND8_ONCE);
    _SF_ALL_QMAP_SORT.insert(116, SF_USER_SOUND8_RPT);
    _SF_ALL_QMAP_SORT.insert(117, SF_USER_SOUND8_OFF);
    _SF_ALL_QMAP_SORT.insert(118, SF_USER_SOUND9_ONCE);
    _SF_ALL_QMAP_SORT.insert(119, SF_USER_SOUND9_RPT);
    _SF_ALL_QMAP_SORT.insert(120, SF_USER_SOUND9_OFF);
    _SF_ALL_QMAP_SORT.insert(121, SF_USER_SOUND10_ONCE);
    _SF_ALL_QMAP_SORT.insert(122, SF_USER_SOUND10_RPT);
    _SF_ALL_QMAP_SORT.insert(123, SF_USER_SOUND10_OFF);
    _SF_ALL_QMAP_SORT.insert(124, SF_USER_SOUND11_ONCE);
    _SF_ALL_QMAP_SORT.insert(125, SF_USER_SOUND11_RPT);
    _SF_ALL_QMAP_SORT.insert(126, SF_USER_SOUND11_OFF);
    _SF_ALL_QMAP_SORT.insert(127, SF_USER_SOUND12_ONCE);
    _SF_ALL_QMAP_SORT.insert(128, SF_USER_SOUND12_RPT);
    _SF_ALL_QMAP_SORT.insert(129, SF_USER_SOUND12_OFF);
    _SF_ALL_QMAP_SORT.insert(130, SF_USER_SOUND_ALL_OFF);
    _SF_ALL_QMAP_SORT.insert(131, SF_SBA_PLAYSTOP);
    _SF_ALL_QMAP_SORT.insert(132, SF_SBA_NEXT);
    _SF_ALL_QMAP_SORT.insert(133, SF_SBA_PREVIOUS);
    _SF_ALL_QMAP_SORT.insert(134, SF_SBA_RANDOM);
    _SF_ALL_QMAP_SORT.insert(135, SF_SBB_PLAYSTOP);
    _SF_ALL_QMAP_SORT.insert(136, SF_SBB_NEXT);
    _SF_ALL_QMAP_SORT.insert(137, SF_SBB_PREVIOUS);
    _SF_ALL_QMAP_SORT.insert(138, SF_SBB_RANDOM);
    _SF_ALL_QMAP_SORT.insert(139, SF_RC1_PASS);
    _SF_ALL_QMAP_SORT.insert(140, SF_RC2_PASS);
    _SF_ALL_QMAP_SORT.insert(141, SF_RC3_PASS);
    _SF_ALL_QMAP_SORT.insert(142, SF_RC4_PASS);
    _SF_ALL_QMAP_SORT.insert(143, SF_RC6_PASS);
    _SF_ALL_QMAP_SORT.insert(144, SF_RC7_PASS);
    _SF_ALL_QMAP_SORT.insert(145, SF_RC8_PASS);
    _SF_ALL_QMAP_SORT.insert(146, SF_RC1_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(147, SF_RC2_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(148, SF_RC3_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(149, SF_RC4_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(150, SF_RC6_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(151, SF_RC7_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(152, SF_RC8_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(153, SF_BARREL_STAB_ON);
    _SF_ALL_QMAP_SORT.insert(154, SF_BARREL_STAB_OFF);
    _SF_ALL_QMAP_SORT.insert(155, SF_BARREL_STAB_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(156, SF_BARREL_STAB_LEVEL);
    _SF_ALL_QMAP_SORT.insert(157, SF_HILLS_ON);
    _SF_ALL_QMAP_SORT.insert(158, SF_HILLS_OFF);
    _SF_ALL_QMAP_SORT.insert(159, SF_HILLS_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(160, SF_HILLS_LEVEL);
    _SF_ALL_QMAP_SORT.insert(161, SF_USER_FUNC_1);
    _SF_ALL_QMAP_SORT.insert(162, SF_USER_FUNC_2);
    _SF_ALL_QMAP_SORT.insert(163, SF_USER_ANLG_1);
    _SF_ALL_QMAP_SORT.insert(164, SF_USER_ANLG_2);
    _SF_ALL_QMAP_SORT.insert(165, SF_DUMP_DEBUG);
...
QMap<_special_function, QString> OP_QMaps::getDigitalSpecialFunctionsQMap()
{
    ...
    _SF_DIGITAL_QMAP.insert(SF_IR_ENABLE, "IR - Enable");
    _SF_DIGITAL_QMAP.insert(SF_IR_DISABLE, "IR - Disable");
    _SF_DIGITAL_QMAP.insert(SF_IR_TOGGLE, "IR - Toggle On/Off");
    ...
    _SF_DIGITAL_QMAP.insert(SF_USER_SOUND_ALL_OFF, "User Sounds - Stop All");
    ...
    _SF_DIGITAL_QMAP.insert(SF_SMOKER_MANTOGGLE, "Smoker - Manual Toggle");
// DISABLED FOR NOW
...
//    _SF_DIGITAL_QMAP.insert(SF_HILLS_TOGGLE, "Hill Physics - Toggle");
    ...
    _SF_DIGITAL_QMAP.insert(SF_SMOKE_PREHEAT_ON, "Smoker Preheat - Enable");
    _SF_DIGITAL_QMAP.insert(SF_SMOKE_PREHEAT_OFF, "Smoker Preheat - Disable");
    _SF_DIGITAL_QMAP.insert(SF_SMOKE_PREHEAT_TOGGLE, "Smoker Preheat - Toggle");
