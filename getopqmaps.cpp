...
QList<_special_function> OP_QMaps::getAllSpecialFunctionsSortOrder()
{
    ...
    _SF_ALL_QMAP_SORT.insert(99, SF_RC1_PASS);
    _SF_ALL_QMAP_SORT.insert(100, SF_RC2_PASS);
    _SF_ALL_QMAP_SORT.insert(101, SF_RC3_PASS);
    _SF_ALL_QMAP_SORT.insert(102, SF_RC4_PASS);
    _SF_ALL_QMAP_SORT.insert(103, SF_RC6_PASS);
    _SF_ALL_QMAP_SORT.insert(104, SF_RC7_PASS);
    _SF_ALL_QMAP_SORT.insert(105, SF_RC8_PASS);
    _SF_ALL_QMAP_SORT.insert(106, SF_RC1_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(107, SF_RC2_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(108, SF_RC3_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(109, SF_RC4_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(110, SF_RC6_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(111, SF_RC7_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(112, SF_RC8_PASS_PAN);
    _SF_ALL_QMAP_SORT.insert(113, SF_BARREL_STAB_ON);
    _SF_ALL_QMAP_SORT.insert(114, SF_BARREL_STAB_OFF);
    _SF_ALL_QMAP_SORT.insert(115, SF_BARREL_STAB_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(116, SF_BARREL_STAB_LEVEL);
    _SF_ALL_QMAP_SORT.insert(117, SF_HILLS_ON);
    _SF_ALL_QMAP_SORT.insert(118, SF_HILLS_OFF);
    _SF_ALL_QMAP_SORT.insert(119, SF_HILLS_TOGGLE);
    _SF_ALL_QMAP_SORT.insert(120, SF_HILLS_LEVEL);
    _SF_ALL_QMAP_SORT.insert(121, SF_USER_FUNC_1);
    _SF_ALL_QMAP_SORT.insert(122, SF_USER_FUNC_2);
    _SF_ALL_QMAP_SORT.insert(123, SF_USER_ANLG_1);
    _SF_ALL_QMAP_SORT.insert(124, SF_USER_ANLG_2);
    _SF_ALL_QMAP_SORT.insert(125, SF_DUMP_DEBUG);
