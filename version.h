...
#define VER_FILEVERSION              0,93,05,00
#define VER_FILEVERSION_STR         "0.93.05.00\0"
...
#define VER_PRODUCTVERSION           0,93,05,00
#define VER_PRODUCTVERSION_STR      "0.93.05\0"

// THIS VERSION IS THE MINIMUM VERSION OF TCB FIRMWARE NEEDED FOR THIS VERSION OF OP CONFIG:
#define VER_MINTCB_STR              "0.93.05\0"
