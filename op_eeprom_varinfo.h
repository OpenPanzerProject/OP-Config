...
const _storage_var_info STORAGEVARS[NUM_STORED_VARS] = {
    ...
    {2211, 319, varBOOL, "1"},        // SmokerControlAuto
    {2212, 320, varINT16, "89"},        // SmokerIdleSpeed
    {2213, 322, varINT16, "128"},        // SmokerFastIdleSpeed
    {2214, 324, varINT16, "255"},        // SmokerMaxSpeed
    {2215, 326, varINT16, "255"},        // SmokerDestroyedSpeed
    {2411, 328, varBOOL, "1"},        // AccelRampEnabled_1
    {2412, 329, varUINT8, "4"},        // AccelSkipNum_1
    {2413, 330, varUINT8, "0"},        // AccelPreset_1
    {2414, 331, varBOOL, "1"},        // DecelRampEnabled_1
    {2415, 332, varUINT8, "4"},        // DecelSkipNum_1
    {2416, 333, varUINT8, "0"},        // DecelPreset_1
    {2417, 334, varBOOL, "0"},        // AccelRampEnabled_2
    {2418, 335, varUINT8, "1"},        // AccelSkipNum_2
    {2419, 336, varUINT8, "0"},        // AccelPreset_2
    {2420, 337, varBOOL, "0"},        // DecelRampEnabled_2
    {2421, 338, varUINT8, "1"},        // DecelSkipNum_2
    {2422, 339, varUINT8, "0"},        // DecelPreset_2
    {2423, 340, varUINT8, "40"},        // BrakeSensitivityPct
    {2424, 341, varUINT16, "1000"},        // TimeToShift_mS
    {2425, 343, varUINT16, "1000"},        // EnginePauseTime_mS
    {2426, 345, varUINT16, "2000"},        // TransmissionDelay_mS
    {2427, 347, varBOOL, "1"},        // NeutralTurnAllowed
    {2428, 348, varUINT8, "50"},        // NeutralTurnPct
    {2429, 349, varUINT8, "2"},        // TurnMode
    {2430, 350, varUINT8, "1"},        // DriveType
    {2431, 351, varUINT8, "100"},        // MaxForwardSpeedPct
    {2432, 352, varUINT8, "70"},        // MaxReverseSpeedPct
    {2433, 353, varUINT8, "50"},        // HalftrackTreadTurnPct
    {2434, 354, varBOOL, "0"},        // EngineAutoStart
    {2435, 355, varINT32, "0"},        // EngineAutoStopTime_mS
    {2436, 359, varUINT8, "0"},        // MotorNudgePct
    {2437, 360, varUINT16, "250"},        // NudgeTime_mS
    {2438, 362, varBOOL, "0"},        // DragInnerTrack
    {2439, 363, varBOOL, "0"},        // EnableTrackRecoil
    {2440, 364, varUINT8, "100"},        // TrackRecoilKickbackSpeed
    {2441, 365, varUINT8, "65"},        // TrackRecoilDecelerateFactor
    {2511, 366, varBOOL, "0"},        // EnableBarrelStabilize
    {2512, 367, varUINT8, "50"},        // BarrelSensitivity
    {2513, 368, varBOOL, "0"},        // EnableHillPhysics
    {2514, 369, varUINT8, "50"},        // HillSensitivity
    {2711, 370, varINT16, "350"},        // IgnoreTurretDelay_mS
    {2811, 372, varUINT8, "0"},        // SoundDevice
    {2812, 373, varUINT16, "1500"},        // Squeak1_MinInterval_mS
    {2813, 375, varUINT16, "4000"},        // Squeak1_MaxInterval_mS
    {2814, 377, varUINT16, "2000"},        // Squeak2_MinInterval_mS
    {2815, 379, varUINT16, "5000"},        // Squeak2_MaxInterval_mS
    {2816, 381, varUINT16, "3000"},        // Squeak3_MinInterval_mS
    {2817, 383, varUINT16, "8000"},        // Squeak3_MaxInterval_mS
    {2818, 385, varBOOL, "0"},        // Squeak1_Enabled
    {2819, 386, varBOOL, "0"},        // Squeak2_Enabled
    {2820, 387, varBOOL, "0"},        // Squeak3_Enabled
    {2821, 388, varUINT8, "25"},        // MinSqueakSpeed
    {2822, 389, varBOOL, "1"},        // HeadlightSound_Enabled
    {2823, 390, varBOOL, "1"},        // TurretSound_Enabled
    {2824, 391, varBOOL, "1"},        // BarrelSound_Enabled
    {2825, 392, varUINT16, "1000"},        // Squeak4_MinInterval_mS
    {2826, 394, varUINT16, "2000"},        // Squeak4_MaxInterval_mS
    {2827, 396, varUINT16, "3000"},        // Squeak5_MinInterval_mS
    {2828, 398, varUINT16, "4000"},        // Squeak5_MaxInterval_mS
    {2829, 400, varUINT16, "5000"},        // Squeak6_MinInterval_mS
    {2830, 402, varUINT16, "6000"},        // Squeak6_MaxInterval_mS
    {2831, 404, varBOOL, "0"},        // Squeak4_Enabled
    {2832, 405, varBOOL, "0"},        // Squeak5_Enabled
    {2833, 406, varBOOL, "0"},        // Squeak6_Enabled
    {2834, 407, varUINT8, "50"},        // VolumeEngine
    {2835, 408, varUINT8, "50"},        // VolumeTrackOverlay
    {2836, 409, varUINT8, "50"},        // VolumeEffects
    {2837, 410, varBOOL, "0"},        // HeadlightSound2_Enabled
    {2838, 411, varBOOL, "0"},        // SoundBankA_Loop
    {2839, 412, varBOOL, "0"},        // SoundBankB_Loop
    {3011, 413, varUINT8, "1"},        // IR_FireProtocol
    {3012, 414, varUINT8, "0"},        // IR_HitProtocol_2
    {3013, 415, varUINT8, "10"},        // IR_RepairProtocol
    {3014, 416, varUINT8, "0"},        // IR_MGProtocol
    {3015, 417, varBOOL, "0"},        // Use_MG_Protocol
    {3016, 418, varBOOL, "0"},        // Accept_MG_Damage
    {3017, 419, varUINT8, "0"},        // DamageProfile
    {3018, 420, varUINT16, "1500"},        // CustomClassSettings.reloadTime
    {3019, 422, varUINT16, "8000"},        // CustomClassSettings.recoveryTime
    {3020, 424, varUINT8, "1"},        // CustomClassSettings.maxHits
    {3021, 425, varUINT8, "10"},        // CustomClassSettings.maxMGHits
    {3022, 426, varBOOL, "0"},        // SendTankID
    {3023, 427, varUINT16, "1"},        // TankID
    {3024, 429, varUINT8, "0"},        // IR_Team
    {3211, 430, varUINT32, "115200"},        // USBSerialBaud
    {3212, 434, varUINT32, "115200"},        // AuxSerialBaud
    {3213, 438, varUINT32, "38400"},        // MotorSerialBaud
    {3214, 442, varUINT32, "38400"},        // Serial3TxBaud
    {3215, 446, varBOOL, "0"},        // LVC_Enabled
    {3216, 447, varUINT16, "6400"},        // LVC_Cutoff_mV
    {3411, 449, varBOOL, "0"},        // RunningLightsAlwaysOn
    {3412, 450, varUINT8, "30"},        // RunningLightsDimLevelPct
    {3413, 451, varBOOL, "0"},        // BrakesAutoOnAtStop
    {3414, 452, varUINT16, "30"},        // AuxLightFlashTime_mS
    {3415, 454, varUINT16, "30"},        // AuxLightBlinkOnTime_mS
    {3416, 456, varUINT16, "30"},        // AuxLightBlinkOffTime_mS
    {3417, 458, varUINT8, "30"},        // AuxLightPresetDim
    {3418, 459, varUINT8, "30"},        // MGLightBlink_mS
    {3419, 460, varBOOL, "1"},        // FlashLightsWhenSignalLost
    {3420, 461, varBOOL, "1"},        // HiFlashWithCannon
    {3421, 462, varBOOL, "0"},        // AuxFlashWithCannon
    {3422, 463, varUINT8, "30"},        // SecondMGLightBlink_mS
    {3423, 464, varBOOL, "1"},        // CannonReloadBlink
    {3611, 465, varUINT8, "12"},        // ScoutCurrentLimit
    {9011, 466, varBOOL, "1"},        // PrintDebug
    {9999, 467, varUINT32, "43589"}        // InitStamp
};
